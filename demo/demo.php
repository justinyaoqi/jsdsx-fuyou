...
//    exit();
    $c = ScanCodeService::M2S("12262018414115417420", \Jsdsx\FuYou\Api::PAYMENT_QQ, 1, '28256好商品', "28257商品描述282931");
...
html;
        ...
        //查寻结果为支付成功
        $c = \Jsdsx\FuYou\Service\OrderService::OrderQuery($_GET['order_sn'], \Jsdsx\FuYou\Api::PAYMENT_QQ);
        var_dump($c);
...
if ($_GET['type'] == '3') {
    //申请退款  返回结果为成功
    $c = \Jsdsx\FuYou\Service\OrderService::refund($_GET['order_sn'], \Jsdsx\FuYou\Api::PAYMENT_QQ, substr(md5(uniqid()),0,30), 1, 1, 1);
    var_dump($c);
}
if ($_GET['type'] == '4') {
    //查询可提现余额
