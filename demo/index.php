...
class A2Xml {   
  ...
  function SendDataByCurl($url,$data){
      ...
      curl_setopt($ch,CURLOPT_TIMEOUT,3); //定义超时3秒钟 
       // POST数据
      curl_setopt($ch, CURLOPT_POST, 1);var_dump(1,$data);
      // 把post的变量加上
...
$data['order_amt']="10";
$data['notify_url']="https://localhost/xdf_pay_back.php";
...
$data['goods_tag']="";
$data['version']="1";
$data['random_str']=1530517879;
$data['mchnt_order_no']="ADFF20180512";
